...
{
    /// <summary>
    /// A sensor that memorizes the initial frame of a Camera at the beginning of each episode.
    /// </summary>
    public class InitialFrameCameraSensor : ISensor, IDisposable
    {
        Camera m_Camera;
        int m_Width;
        int m_Height;
        ...
        public InitialFrameCameraSensor(
        ...
        /// <summary>
        /// Manually record the current frame
        /// </summary>
